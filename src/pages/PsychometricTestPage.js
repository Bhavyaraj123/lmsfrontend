...
const PsychometricTestPage = () => {
  ...
  return (
    <>
      <div className="w-full">
        ...
        <section className="bg-gradient-to-r from-blue-500 to-teal-400 text-white py-16 px-4 lg:px-10 text-center">
  ...
  <div className="container mx-auto mb-5">
    <div className="flex flex-wrap justify-center">
      {/* Card 1 */}
      <div className="p-2 w-full sm:w-1/2 lg:w-1/4 hover:scale-105 transition duration-300 box-border">
        <div className="h-full bg-white rounded-lg drop-shadow-lg p-4 flex flex-col justify-between shadow-xl">
          <div>
            ...
            <p className="leading-relaxed text-sm">
              Gain a comprehensive understanding of your personality through structured analysis. Assess key personality dimensions like Extraversion, Agreeableness, and Conscientiousness to better understand yourself and how you interact with the world.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 w-full sm:w-1/2 lg:w-1/4 hover:scale-105 transition duration-300 box-border">
        <div className="h-full bg-white rounded-lg drop-shadow-lg p-4 flex flex-col justify-between shadow-xl">
          <div>
            ...
            <p className="leading-relaxed text-sm">
              Identify career paths that align with your strengths and interests. Receive tailored recommendations for careers that fit your personality, skills, and values, helping you make informed career decisions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 w-full sm:w-1/2 lg:w-1/4 hover:scale-105 transition duration-300 box-border">
        <div className="h-full bg-white rounded-lg drop-shadow-lg p-4 flex flex-col justify-between shadow-xl">
          <div>
            ...
            <p className="leading-relaxed text-sm">
              Map your skills and competencies for professional growth. Understand your existing skills and identify areas for development, enabling you to build a strong foundation for career advancement.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 w-full sm:w-1/2 lg:w-1/4 hover:scale-105 transition duration-300 box-border">
        <div className="h-full bg-white rounded-lg drop-shadow-lg p-4 flex flex-col justify-between shadow-xl">
          <div>
            ...
            <p className="leading-relaxed text-sm">
              Make well-informed decisions with confidence. Use the insights gained from psychometric assessments to guide important life choices, such as educational paths, career moves, and personal development goals.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-wrap justify-center mx-auto">
      ...
      <div className="p-4 w-full sm:w-1/2 lg:w-1/4 bg-gray-100 mr-0 md:mr-6 mb-4 md:mb-0 rounded-md hover:scale-105 transition duration-300">
        <div className="h-full flex flex-col items-center text-center">
          <img src={man} alt="Team Member" className="w-[50%] md:w-[70%] h-[50%] md:h-[70%] p-5 object-cover" />
          <div className="w-full">
      ...
      <div className="p-4 w-full sm:w-1/2 lg:w-1/4 bg-gray-100 mr-0 md:mr-6 mb-4 md:mb-0 rounded-md hover:scale-105 transition duration-300">
        <div className="h-full flex flex-col items-center text-center">
          <img src={woman} alt="Team Member" className="w-[50%] md:w-[70%] h-[50%] md:h-[70%] p-5 object-cover" />
          <div className="w-full">
  ...
  <h1 className="text-2xl md:text-3xl lg:text-4xl text-center mb-10 text-blue-500 font-semibold">Frequently Asked Questions (FAQs)</h1>

  {/* Accordion Item 1 */}
  <div className="mx-2 md:mx-20 p-3 py-1 bg-white rounded-lg border border-gray-300 shadow-md mb-2">
    <button className="container flex justify-between my-2 items-center" onClick={() => setAccordion(!Accordion)}>
      <span className="text-lg md:text-xl font-semibold">1. What Is Psychometric Test?</span>
      {Accordion ? <span className="text-3xl md:text-4xl">-</span> : <span className="text-3xl md:text-4xl">+</span>}
    </button>
    <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-md ${Accordion ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
      <div className="overflow-hidden pt-2 border-t border-gray-200">
        A psychometric test is a tool used to measure an individual's mental capabilities and personality traits. It helps assess various psychological characteristics to gain insights into behavior, abilities, and potential, often used for recruitment and personal development.
      </div>
    </div>
  </div>
  ...
  {/* Accordion Item 2 */}
  <div className="mx-2 md:mx-20 p-3 py-1 bg-white rounded-lg border border-gray-300 shadow-md mb-2">
    <button className="container flex justify-between my-2 items-center" onClick={() => setAccordion2(!Accordion2)}>
      <span className="text-lg md:text-xl font-semibold">2. How Long Does The Psychometric Test Take?</span>
      {Accordion2 ? <span className="text-3xl md:text-4xl">-</span> : <span className="text-3xl md:text-4xl">+</span>}
    </button>
    <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-md ${Accordion2 ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
      <div className="overflow-hidden pt-2 border-t border-gray-200">
        The duration of a psychometric test varies depending on the type and complexity of the test. Typically, it can range from 30 minutes to an hour, but some comprehensive tests may take longer.
      </div>
    </div>
  </div>
  ...
  {/* Accordion Item 3 */}
  <div className="mx-2 md:mx-20 p-3 py-1 bg-white rounded-lg border border-gray-300 shadow-md mb-2">
    <button className="container flex justify-between my-2 items-center" onClick={() => setAccordion3(!Accordion3)}>
      <span className="text-lg md:text-xl font-semibold">3. Are Psychometric Tests Reliable?</span>
      {Accordion3 ? <span className="text-3xl md:text-4xl">-</span> : <span className="text-3xl md:text-4xl">+</span>}
    </button>
    <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-md ${Accordion3 ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
      <div className="overflow-hidden pt-2 border-t border-gray-200">
        Yes, psychometric tests are designed to be reliable and valid measures of psychological traits. When administered correctly, they provide consistent and accurate insights into an individual's capabilities and personality.
      </div>
    </div>
  </div>
...
{/* Accordion Item 4 */}
<div className="mx-2 md:mx-20 p-3 py-1 bg-white rounded-lg border border-gray-300 shadow-md mb-2">
    <button className="container flex justify-between my-2 items-center" onClick={() => setAccordion4(!Accordion4)}>
      <span className="text-lg md:text-xl font-semibold">4.Can you prepare for a psychometric assessment?</span>
      {Accordion4 ? <span className="text-3xl md:text-4xl">-</span> : <span className="text-3xl md:text-4xl">+</span>}
    </button>
    <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-md ${Accordion4 ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
      <div className="overflow-hidden pt-2 border-t border-gray-200">
      While you can't change your inherent personality traits, you can prepare for the cognitive aspects of a psychometric assessment by practicing similar tests, familiarizing yourself with the types of questions asked, and improving your time management skills. Many practice tests are available online to help you prepare.      </div>
    </div>
  </div>

  {/* Accordion Item 5 */}
  <div className="mx-2 md:mx-20 p-3 py-1 bg-white rounded-lg border border-gray-300 shadow-md mb-2">
    <button className="container flex justify-between my-2 items-center" onClick={() => setAccordion5(!Accordion5)}>
      <span className="text-lg md:text-xl font-semibold">5. How are Psychometric Assessments Useful in the Medical Field?</span>
      {Accordion5 ? <span className="text-3xl md:text-4xl">-</span> : <span className="text-3xl md:text-4xl">+</span>}
    </button>
    <div className={`grid overflow-hidden transition-all duration-300 ease-in-out text-md ${Accordion5 ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
      <div className="overflow-hidden pt-2 border-t border-gray-200">
      Psychometric assessments in the medical field are valuable tools for evaluating the psychological traits and cognitive abilities of healthcare professionals. They help in assessing skills like critical thinking, problem-solving, empathy, and stress management, which are crucial for patient care. These assessments are also used in medical education and training to identify areas where individuals may need development, ensuring that medical staff are well-suited for their demanding roles. Additionally, psychometric tests can be used in patient care to understand psychological aspects of health conditions, aiding in the diagnosis and treatment planning process.      </div>
    </div>
  </div>
</section>
